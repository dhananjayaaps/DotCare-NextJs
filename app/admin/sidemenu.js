        ...
        <div className="px-4 py-6">
          ...
          <li>
            ...
            <li>
              <a
                href="/admin/admins"
                className={`block rounded-lg px-4 py-2 text-sm font-medium ${isActive('admins')}`}
              >
                Admin
              </a>
            </li>
            ...
            <li>
              <a
                href="/admin/doctors"
                className={`block rounded-lg px-4 py-2 text-sm font-medium ${isActive('doctors')} hover:bg-gray-100 hover:text-gray-700`}
              >
                Doctors
              </a>
            </li>
