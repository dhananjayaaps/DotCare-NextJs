      ...
      <div className="flex h-screen w-56 flex-col justify-between border-e bg-white">
        <div className="px-4 py-6">
          ...
          <li>
              <a
                href="#"
                className={`block rounded-lg px-4 py-2 text-sm font-medium ${isActive('Billing')} hover:bg-gray-100 hover:text-gray-700`}
              >
                Home
              </a>
            </li>
            ...
            <li>
              <a
                href="#"
                className={`block rounded-lg px-4 py-2 text-sm font-medium ${isActive('Admin')}`}
              >
                Admin
              </a>
            </li>
            ...
            <li>
              <a
                href="#"
                className={`block rounded-lg px-4 py-2 text-sm font-medium ${isActive('Invoices')} hover:bg-gray-100 hover:text-gray-700`}
              >
                Miwifes
              </a>
            </li>
          ...
          <a href="#" className="flex items-center gap-2 bg-white p-4 hover:bg-gray-50">
            ...
            <div>
              <p className="text-xs">
                ...
                <span> Thenu@frusciante.com </span>
              </p>
            </div>
          </a>
        </div>
